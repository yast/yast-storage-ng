...
describe Y2Partitioner::Widgets::BcacheDescription do
  before do
  ...
  describe "#init" do
    ...
    it "includes a bcache section" do
      expect(Y2Partitioner::Widgets::DescriptionSection::Bcache).to receive(:new)
        .and_call_original
