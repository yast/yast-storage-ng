...
describe Y2Partitioner::Widgets::DescriptionSection::LvmVgDevice do
  ...
  describe "#value" do
    ...
    it "includes an entry about the VG name" do
      expect(subject.value).to match(/Device:/)
    end

    it "includes an entry about the VG size" do
  ...
  describe "#help_fields" do
    ...
    it "includes a help field for the VG name" do
      expect(subject.help_fields).to include(:device)
    end

    it "includes a help field for the VG size" do
