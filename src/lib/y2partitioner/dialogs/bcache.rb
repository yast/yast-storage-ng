...
module Y2Partitioner
  module Dialogs
    # Form to set the backing and caching device for a Backed Bcache device
    ...
    class Bcache < Base
      ...
      # @param device [Y2Storage::BackedBcache] existing Bcache device or nil if it is a new one.
      ...
      class CachingDevice < CWM::ComboBox
        ...
        #   used as caching device for the Backed Bcache
